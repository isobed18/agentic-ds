...
describe("the project-first journey (#157, #165)", () => {
  ...
  it("carries the chosen ML target into the guided run (#244/#198)", () => {
    ...
    expect(AUTOMATION_SOURCE).toContain("onRun={(runMode, target, checkpointStages, problemKind) => void runAcceptedWorkflow(runMode, target, checkpointStages, problemKind)}");
