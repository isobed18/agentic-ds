...
function AutomationEditor({ projectId, automationId }: { projectId: string; automationId: string }) {
  ...
  async function runAcceptedWorkflow(runMode: "fully_auto" | "manual" = "fully_auto", targetColumn: string | null = null) {
