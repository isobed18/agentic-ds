...
const TR: Record<string, string> = {
  ...
  "Unchecked tables are recorded as rejected.": "İşaretlenmemiş tablolar reddedilmiş olarak kaydedilir.",
  "Check at least one table to promote.": "Veriye almak için en az bir tabloyu işaretleyin.",
