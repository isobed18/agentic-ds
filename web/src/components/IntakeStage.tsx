...
export function IntakeStage({
  ...
  const [runMode, setRunMode] = useState<"auto" | "manual" | "fully_auto">("auto");
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            ...
            <Field label={t("Supervision")}>
              <div className="flex gap-1.5">
                {(["auto", "manual", "fully_auto"] as const).map((value) => (
                  <button
                    key={value}
                  ...
                  >
                    ...
                    <span className="mt-0.5 block leading-snug text-ink-mute">
                      {value === "auto"
                        ...
                        : value === "fully_auto"
                        ? t("Accept the saved planner configuration; only hard safety gates can stop it.")
