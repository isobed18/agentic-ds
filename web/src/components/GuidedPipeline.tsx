...
function GuidedNode({ title, subtitle, status, waiting = false, dimmed = false, footer, artifactIds, activeArtifactId, onClick, onOpenArtifact }: { title: string; subtitle: string; status: WorkflowNode["status"]; waiting?: boolean; dimmed?: boolean; footer?: string; artifactIds: string[]; activeArtifactId?: string | null; onClick: () => void; onOpenArtifact: (id: string) => void }) {
