...
function GuidedNode({ title, subtitle, status, waiting = false, dimmed = false, checkpointStages, footer, note, artifactIds, onClick, onOpenArtifact }: { title: string; subtitle: string; status: WorkflowNode["status"]; waiting?: boolean; dimmed?: boolean; checkpointStages: string[]; footer?: string; note?: NonNullable<WorkflowNode["note"]>; artifactIds: string[]; onClick: () => void; onOpenArtifact: (id: string) => void }) {
