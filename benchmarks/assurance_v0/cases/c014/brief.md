...
The notebook uses GroupShuffleSplit with borrower_id as the grouping variable and a 25 percent
holdout. It then fits preprocessing and the classifier on the resulting development rows and
scores the resulting holdout rows.
